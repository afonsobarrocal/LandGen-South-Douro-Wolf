...
+ `scripts`:
  ...
  + `data`:
    ...
    + `tif`: here, there is only one type of file: compressed folders (.zip). Inside these folders, you will find the raster layers used in the R scripts (in .asc format).
